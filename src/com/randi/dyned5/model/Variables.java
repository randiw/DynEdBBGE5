...
public class Variables {
	...
	public static final String CONVERSATION_CODE = "GE5";
	public static final String APP_NAME = "General English 5";
	public static final String APP_ID = "100005";

	public static final String SPLASH_NAME = "General English / 5";
